...
Kisse::Maths::Vector3d C03PacketPlayer::getXYZ()
{
	if (!instance)
...
void C03PacketPlayer::setXYZ(const Kisse::Maths::Vector3d& vector)
{
	if (!instance)
		return;
...
Kisse::Maths::Vector2d C03PacketPlayer::getYawPitch()
{
	if (!instance)
...
void C03PacketPlayer::setYawPitch(Kisse::Maths::Vector2d yawPitch)
{
	if (!instance)
		return;
