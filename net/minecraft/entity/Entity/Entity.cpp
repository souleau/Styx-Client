...
Kisse::Maths::Vector3d Entity::getPosition() const
{
...
Kisse::Maths::Vector3d Entity::getLastTickPosition() const
{
	if (!instance) return Kisse::Maths::Vector3d();
	return Kisse::Maths::Vector3d
	(
...
Kisse::Maths::Vector3d Entity::getMovementVector(float partialTicks) const
{
	if (!instance) return Kisse::Maths::Vector3d();
	return (getPosition() - getLastTickPosition()) * partialTicks;
}

Kisse::Maths::Vector3d Entity::getRenderPos(float partialTicks) const
{
	return getLastTickPosition() + getMovementVector(partialTicks);
}

Kisse::Maths::Vector2d Entity::getRotation() const
{
	if (!instance) return Kisse::Maths::Vector2d();
	return Kisse::Maths::Vector2d(
...
Kisse::Maths::Vector2d Entity::getPrevRotation() const
{
	if (!instance) return Kisse::Maths::Vector2d();
	return Kisse::Maths::Vector2d(
...
Kisse::Maths::Vector2d Entity::getRenderRotation(float partialTicks) const
{
	return getPrevRotation() + ((getRotation() - getPrevRotation()) * partialTicks);
}

Kisse::Maths::Vector3d Entity::getMotion() const
{
	if (!instance) return Kisse::Maths::Vector3d();
	if (Kisse::version.type == Kisse::Version::MAJOR_1_16_5 || Kisse::version.type == Kisse::Version::MAJOR_1_19_4)
	{
...
void Entity::setPosition(const Kisse::Maths::Vector3d& position)
{
	if (!instance) return;
...
void Entity::setMotion(const Kisse::Maths::Vector3d& motion)
{
	if (!instance) return;
	if (Kisse::version.type == Kisse::Version::MAJOR_1_16_5 || Kisse::version.type == Kisse::Version::MAJOR_1_19_4)
	{
...
void Entity::setRotation(const Kisse::Maths::Vector2d& yawPitch)
{
	if (!instance) return;
...
void Entity::setPositionAndUpdate(const Kisse::Maths::Vector3d& position)
{
	if (!instance)
		return;
	env->CallVoidMethod(
