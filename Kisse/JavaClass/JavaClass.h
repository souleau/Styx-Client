...
namespace Kisse
{
	...
	public:
		...
		static jclass findClass(const std::string& class_path, JNIEnv* env = Kisse::p_env);
		...
		jclass get_jclass(JNIEnv* env = Kisse::p_env) const; // a class reference is env / thread specific
