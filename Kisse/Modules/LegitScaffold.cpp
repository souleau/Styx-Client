...
void Kisse::Modules::LegitScaffold::onUpdateWalkingPlayer(JNIEnv* env, EntityPlayerSP& this_player, bool* cancel)
{
	if (!enabled)
		return;
	...
	if ((GetKeyState(0x53) & 0x8000) && thePlayer.isOnGround())
	{
		...
		Kisse::Maths::Vector3d playerPosition
		(
...
void Kisse::Modules::LegitScaffold::renderGUI()
{
