...
Kisse::Maths::Vector2d Kisse::Maths::getYawPitch(Vector3d playerPos, Vector3d facingPos)
{
...
Kisse::Maths::Vector3d Kisse::Maths::getCameraVector(Vector2d cameraRot, double distance)
{
...
double Kisse::Maths::cropAngle180(double angle)
{
...
double Kisse::Maths::cropAngle360(double angle)
{
...
double Kisse::Maths::worldToScreen(Vector3d world_pos, Matrix modelView, Matrix projection, int screenWidth, int screenHeight, Vector2d& screen_pos)
{
	Matrix world_matrix =
	{
...
Kisse::Maths::Vector3d::Vector3d()
{
}

Kisse::Maths::Vector3d::Vector3d(double x, double y, double z)
{
	this->x = x;
	this->y = y;
	this->z = z;
...
Kisse::Maths::Vector3d Kisse::Maths::Vector3d::operator-(const Vector3d& other_vector)
{
...
Kisse::Maths::Vector3d Kisse::Maths::Vector3d::operator*(double coef)
{
	return Vector3d(x * coef, y * coef, z * coef);
}

double Kisse::Maths::Vector3d::distance()
{
	return std::sqrt(x*x + y*y + z*z);
}

Kisse::Maths::Vector2d::Vector2d()
{
}

Kisse::Maths::Vector2d::Vector2d(double x, double y)
{
	this->x = x;
	this->y = y;
}

Kisse::Maths::Vector2d Kisse::Maths::Vector2d::operator-(const Vector2d& other_vector)
{
...
Kisse::Maths::Vector2d Kisse::Maths::Vector2d::operator*(double coef)
{
	return Vector2d(x * coef, y * coef);
}

Kisse::Maths::Vector2d Kisse::Maths::Vector2d::crop180()
{
	return Vector2d(cropAngle180(x), cropAngle180(y));
}

double Kisse::Maths::Vector2d::distance()
{
	return std::sqrt(x * x + y * y);
}

Kisse::Maths::Matrix::Matrix(int line_number, int column_number, double fill_number) :
...
Kisse::Maths::Matrix::Matrix(const Matrix& other_matrix) :
...
Kisse::Maths::Matrix::Matrix(std::initializer_list<std::initializer_list<double>> init) :
...
Kisse::Maths::Matrix& Kisse::Maths::Matrix::operator=(const Matrix& other_matrix)
{
...
double* Kisse::Maths::Matrix::operator[](int index)
{
...
Kisse::Maths::Matrix::operator bool() const
{
	return is_valid();
}

Kisse::Maths::Matrix Kisse::Maths::Matrix::operator*(const Matrix& other_matrix) const
{
...
bool Kisse::Maths::Matrix::is_valid() const
{
	return line_number && column_number;
}

std::string Kisse::Maths::Matrix::to_string() const
{
	std::string result{};
	for (int i = 0; i < line_number; i++)
	{
...
void Kisse::Maths::Matrix::destroy_data()
{
	if (data)
	{
		for (int i = 0; i < line_number; ++i)
